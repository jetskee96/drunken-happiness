...
class PoemsControllerTest < ActionController::TestCase
  ...
  test "should create poem" do
    assert_difference('Poem.count') do
      post :create, poem: { genre: @poem.genre, name: @poem.name, synopsis: @poem.synopsis, theme: @poem.theme }
    end
  ...
  test "should update poem" do
    patch :update, id: @poem, poem: { genre: @poem.genre, name: @poem.name, synopsis: @poem.synopsis, theme: @poem.theme }
    assert_redirected_to poem_path(assigns(:poem))
  end
